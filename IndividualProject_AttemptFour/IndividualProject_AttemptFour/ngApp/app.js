...
var MyApp;
(function (MyApp) {
    angular.module('MyApp', ['ngRoute', 'ngResource', 'uiGmapgoogle-maps', 'ui.bootstrap']).config(function ($routeProvider, $locationProvider, uiGmapGoogleMapApiProvider) {
        ...
        $routeProvider
            ...
            .when('/addReview', {
            templateUrl: '/ngApp/views/addReview.html',
            controller: MyApp.Controllers.AddReviewController,
            controllerAs: 'controller'
        })
            .when('/editReview/:id', {
            templateUrl: '/ngApp/views/editReview.html',
            ...
            .when('/searchReview', {
            templateUrl: '/ngApp/views/searchReview.html',
