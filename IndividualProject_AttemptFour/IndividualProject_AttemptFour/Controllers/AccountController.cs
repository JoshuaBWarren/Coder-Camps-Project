...
using IndividualProject_AttemptFour.Providers;
using IndividualProject_AttemptFour.Results;

namespace IndividualProject_AttemptFour.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            UserManager.AddClaim(user.Id, new Claim("self", "true"));
